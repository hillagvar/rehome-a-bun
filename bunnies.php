        ...
        <?php if ($result->num_rows > 0) {
            ...
            <table>
                ...
                foreach ($bunnyData as $bunny) {
                    ...
                    <td>
                        <?php echo $bunny['breed']; ?>
                    </td>
                    <td>
                        <?php echo $bunny['gender']; ?>
                    </td>
                    <td>
                        <?php echo $bunny['group']; ?>
                    </td>
                    <td>
                        <?php
                        if ($bunny['neutered'] == 1) {
                    ...
                    <td>
                        <?php echo $bunny['colour']; ?>
                    </td>
                    <td>
                        <?php echo $bunny['weight']; ?> kg
                    </td>
                    <td>
                        <?php
                        $id = $bunny['id'];
                ...
                WHERE bunnies.id =' . $id;
                    ...
                    <td>
                        <?php echo $bunny['level_of_fluffiness']; ?>
                    </td>
                    <td>
                        <?php echo $bunny['rescue_date']; ?>
                    </td>
